...
[Icons]
Name: "{group}\智能反黄"; Filename: "{app}\troll_ui_app.exe"; WorkingDir: "{app}"; Tasks: startupicon
Name: "{group}\卸载智能反黄"; Filename: "{uninstallexe}"; Tasks: startupicon
;Name: "{Desktop}"; Filename: "{app}\troll_ui_app.exe";
Name: "{commondesktop}\智能反黄"; Filename: "{app}\troll_ui_app.exe"; WorkingDir: "{app}"; Tasks: desktopicon 
