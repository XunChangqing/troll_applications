...
{
    public class BlueProxy : ProxyLogic
    {
        /// <summary>
        ...
        public BlueProxy(HttpSocket clientSocket)
            : base(clientSocket) { }

        static new public BlueProxy CreateProxy(HttpSocket clientSocket)
        {
            return new BlueProxy(clientSocket);
        }
